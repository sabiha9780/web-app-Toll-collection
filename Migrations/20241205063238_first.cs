        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        name: "FK_TollRecords_TollPlazas_TollPlazaId",
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    Id = table.Column<int>(type: "int", nullable: false)
                        .Annotation("SqlServer:Identity", "1, 1"),
                    TollRecordId = table.Column<int>(type: "int", nullable: false),
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        name: "FK_Payments_TollRecords_TollRecordId",
                        column: x => x.TollRecordId,
                        principalTable: "TollRecords",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Cascade);
                });
            ...
            migrationBuilder.CreateIndex(
                name: "IX_Payments_TollRecordId",
                table: "Payments",
                column: "TollRecordId");

            migrationBuilder.CreateIndex(
                name: "IX_TollRecords_TollPlazaId",
                table: "TollRecords",
                column: "TollPlazaId");
